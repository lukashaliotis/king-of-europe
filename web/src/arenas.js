...
export const ARENAS = {
  ...
  RED: [{ name: "Aleksandar Nikolić Hall (Pionir)", from: 2001, to: 2014, rating: 9.0, cap: 8 },
        { name: "Belgrade Arena", from: 2015, to: 2025, rating: 8.5, cap: 19 }],
  ZAL: [{ name: "Kaunas Sports Hall", from: 2001, to: 2010, rating: 8.0, cap: 4.5 },
        { name: "Žalgirio Arena", from: 2011, to: 2025, rating: 9.0, cap: 15.4 }],
  TEL: [{ name: "Menora Mivtachim (Yad Eliyahu)", from: 2001, to: 2025, rating: 9.0, cap: 11.7 }],
  ...
  ULK: [{ name: "Abdi İpekçi Arena", from: 2001, to: 2012, rating: 7.5, cap: 12.3 },
        { name: "Ülker Sports Arena", from: 2013, to: 2025, rating: 8.5, cap: 13.8 }],
  IST: [{ name: "Abdi İpekçi Arena", from: 2001, to: 2016, rating: 8.0, cap: 12.3 },
        { name: "Sinan Erdem Dome", from: 2017, to: 2025, rating: 7.5, cap: 16 }],
  VIR: [{ name: "PalaDozza", from: 2001, to: 2008, rating: 8.5, cap: 5.7 },
        { name: "Segafredo Arena", from: 2019, to: 2025, rating: 8.0, cap: 10 }],
  FOR: [{ name: "PalaDozza", from: 2001, to: 2008, rating: 8.5, cap: 5.7 }],
  PAM: [{ name: "Fuente de San Luis", from: 2001, to: 2024, rating: 8.0, cap: 9 },
        { name: "Roig Arena", from: 2025, to: 2025, rating: 7.5, cap: 15.6 }],
  SIE: [{ name: "PalaEstra", from: 2001, to: 2014, rating: 8.0, cap: 7 }],
  BAM: [{ name: "Brose Arena", from: 2001, to: 2017, rating: 7.5, cap: 6.8 }],
  MAD: [{ name: "WiZink Center", from: 2001, to: 2025, rating: 7.5, cap: 15.5 }],
  MAL: [{ name: "Martín Carpena", from: 2001, to: 2025, rating: 7.5, cap: 11.3 }],
  CIB: [{ name: "Dražen Petrović Hall", from: 2001, to: 2016, rating: 7.5, cap: 5.4 }],
  MCO: [{ name: "Salle Gaston Médecin", from: 2021, to: 2025, rating: 7.5, cap: 5 }],
  BAR: [{ name: "Palau Blaugrana", from: 2001, to: 2025, rating: 7.0, cap: 7.5 }],
  ASV: [{ name: "Astroballe", from: 2001, to: 2023, rating: 7.0, cap: 5.6 },
        { name: "LDLC Arena", from: 2024, to: 2025, rating: 6.5, cap: 12.5 }],
  AEK: [{ name: "OAKA / Ano Liosia", from: 2001, to: 2025, rating: 7.0, cap: 9 }],
  LJU: [{ name: "Tivoli / Stožice", from: 2001, to: 2025, rating: 7.0, cap: 12 }],
  LIE: [{ name: "Rytas Arena", from: 2001, to: 2025, rating: 7.0, cap: 11 }],
  TRE: [{ name: "PalaVerde", from: 2001, to: 2012, rating: 7.0, cap: 5.3 }],
  PAU: [{ name: "Palais des Sports", from: 2001, to: 2010, rating: 7.0, cap: 7.7 }],
  MIL: [{ name: "Mediolanum Forum", from: 2001, to: 2025, rating: 6.5, cap: 12.7 }],
  BER: [{ name: "Max-Schmeling / Mercedes-Benz Arena", from: 2001, to: 2025, rating: 6.5, cap: 14.5 }],
  MUN: [{ name: "Audi Dome", from: 2010, to: 2024, rating: 6.5, cap: 6.7 },
        { name: "SAP Garden", from: 2025, to: 2025, rating: 6.5, cap: 11.5 }],
  ...
  KHI: [{ name: "Mytishchi Arena", from: 2001, to: 2021, rating: 6.0, cap: 7 }],
};
